...
export function GuessForm(props) {
    return (
      ...
      <form class="max-w-sm mx-auto">
        <label for="website-admin" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Enter your guess</label>
        <div class="flex">
